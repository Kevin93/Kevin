...
if (!empty($Filename)) {
	...
	echo '<TABLE BORDER="3" CELLSPACING="0" CELLPADDING="4"><FORM ACTION="'.htmlentities($_SERVER['PHP_SELF'], ENT_QUOTES).'" METHOD="POST" ENCTYPE="multipart/form-data">';
	echo '<TR><TD ALIGN="RIGHT"><B>Filename: </B></TD><TD><INPUT TYPE="HIDDEN" NAME="Filename" VALUE="'.htmlentities($Filename, ENT_QUOTES).'"><A HREF="'.$browsescriptfilename.'?filename='.rawurlencode($Filename).'" TARGET="_blank">'.$Filename.'</A></TD></TR>';
